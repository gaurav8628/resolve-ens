...
const Web3Helper = {
  ...
  getWeb3Provider: function () {
    return new Web3.providers.HttpProvider('https://mainnet.infura.io/v3/96dd03e696ab43f292aace33d937859b');
  },
  // To Get Web3
  ...
  getEthersProvider: function() {
    return new ethers.providers.Web3Provider('https://mainnet.infura.io/v3/96dd03e696ab43f292aace33d937859b');
  },
  // To Get Ethers
